 ...
 */
trigger ContactTrigger on Contact(after insert, before insert, after update) {						// When a contact is inserted
    if (Trigger.isBefore && Trigger.isInsert){
        ContactDummyJsonHandler.handleBeforeInsert(Trigger.new);
    }
    
    if (Trigger.isAfter && Trigger.isInsert) {
        ContactDummyJsonHandler.handleAfterInsert(Trigger.new);
    }

    if (Trigger.isAfter && Trigger.isUpdate){
        ContactDummyJsonHandler.handleAfterUpdate(Trigger.new);
    }     
}    
